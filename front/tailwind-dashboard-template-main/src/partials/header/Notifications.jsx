  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-slate-400 uppercase pt-1.5 pb-2 px-4">Уведомления</div>
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Добро пожаловать!</span>
                Самое время загрузить пару документов и поделиться ими. Если будут какие-то проблемы, мы всегда будем рады Вам помочь! Спасибо, что используете наш сервис!
                </span>
                <span className="block text-xs font-medium text-slate-400">{Date()}</span>
              </Link>
            </li>
          </ul>
        </div>
